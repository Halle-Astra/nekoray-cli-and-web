...
namespace NekoCore {
    ...
    bool NekoService::startProxy() {
        ...
        bool spModeVpn = m_currentConfig.value("spmode_vpn").toBool();
        bool vpnInternalTun = m_currentConfig.value("vpn_internal_tun").toBool();
    ...
    QString NekoService::getSocksAddress() const {
        if (m_currentConfig.contains("inbound_address")) {
            return m_currentConfig.value("inbound_address").toString();
        }
        return m_defaultConfig.value("inbound_address").toString();
    }

    int NekoService::getSocksPort() const {
        if (m_currentConfig.contains("inbound_socks_port")) {
            return m_currentConfig.value("inbound_socks_port").toInt();
        }
        return m_defaultConfig.value("inbound_socks_port").toInt();
    }
    ...
    int NekoService::getHttpPort() const {
        if (m_currentConfig.contains("inbound_http_port")) {
            return m_currentConfig.value("inbound_http_port").toInt();
        }
        return m_defaultConfig.value("inbound_http_port").toInt();
    }
